...
HRESULT CMainApp::Ready_Prototypes()
{
	...
	/* For.Prototype_Component_Event_Handler_ */
	if (FAILED(m_pGameInstance->Add_Prototype(ENUM_CLASS(LEVEL::STATIC), TEXT("Prototype_Component_Event_Handler"),
		CEvent_Handler::Create(m_pGraphic_Device))))
		return E_FAIL;
